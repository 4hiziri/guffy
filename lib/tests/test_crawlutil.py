from guffy import crawlutil as crawl
import unittest
...
'''
    ...
    def test_find_all_urls(self):
        self.assertListEqual(
            crawl.find_all_urls(self.bsObj), ['/index.php', 'this/is/test'])

    def test_abs_path(self):
        self.assertEqual(
            crawl.abs_path('http://www.example.com', '/index.php'),
            'http://www.example.com/index.php')
        self.assertEqual(
            crawl.abs_path('http://www.example.com/under1/', 'under2.txt'),
